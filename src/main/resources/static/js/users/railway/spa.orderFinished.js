...
spa.orderFinished = (function(){
	...
	var initButtons = function(){
		...
		$("#ticket_order_query_btn").click(function(){
			...
			$.get(APP_PATH + "/orderFinished/get/orderFinished", params, function(list){
				...
				$(".ticket-refund").click(function(){
					...
					layer.confirm('确认要退票么?', {icon: 3, title:'退票'}, function(index){
						layer.close(index);
						$.get(APP_PATH + "/orderFinished/update/refundOrder", {orderId:orderId}, function(){
