	...
	var addDivClickEvent = function(){
		$(".order-list-div").click(function(){
			...
			if(state == "open"){
				...
				$.get(APP_PATH + "/orderUnfinished/get/byOrderNo", {orderNo:$(this).attr("orderNo")}, function(list){
					...
					$(".order-cancel").click(function(){
						...
						layer.confirm('确认要取消订单么?', {icon: 3, title:'取消订单'}, function(index){
							layer.close(index);
							$.get(APP_PATH + "/ticketOrder/update/cancelTicketOrder", {orderNo: orderNo}, function(data){
